...
public class Blacksmith extends Mob.NPC {
	...
	public static class Quest {
		...
		private static final String BUNDLE_KEY_NODE = "blacksmith";
		...
		private static final String BUNDLE_KEY_REFORGED = "reforged";
		...
		public static void storeInBundle( Bundle bundle ) {
			...
			if (spawned) {
				...
				node.put(BUNDLE_KEY_REFORGED, reforged);
			}
		...
		public static void restoreFromBundle( Bundle bundle ) {
			...
			if (!node.isNull() && (spawned = node.getBoolean(BUNDLE_KEY_SPAWNED))) {
				...
				reforged = node.getBoolean(BUNDLE_KEY_REFORGED);
			} else {
				reset();
			}
		}
